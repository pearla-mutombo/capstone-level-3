...
var chunk_NXBV2SR2_exports = {};
__export(chunk_NXBV2SR2_exports, {
...
module.exports = __toCommonJS(chunk_NXBV2SR2_exports);
...
var import_chunk_A7W5GDP4 = require("./chunk-A7W5GDP4.js");
var import_chunk_AP4ODVUR = require("./chunk-AP4ODVUR.js");
var import_chunk_JLOOQB4K = require("./chunk-JLOOQB4K.js");
var import_chunk_XLW73IUY = require("./chunk-XLW73IUY.js");
...
async function formatSchema({ schemaPath: schemaPath2, schema }, inputFormattingOptions) {
  ...
  if (process.env.FORCE_PANIC_PRISMA_SCHEMA) {
    handleFormatPanic(
      () => {
        import_chunk_XLW73IUY.prismaSchemaWasm.debug_panic();
      },
  ...
  const { formattedSchema, lintDiagnostics } = handleFormatPanic(
    () => {
      ...
      const lintDiagnostics2 = (0, import_chunk_A7W5GDP4.lintSchema)({ schema: formattedSchema2 });
      return { formattedSchema: formattedSchema2, lintDiagnostics: lintDiagnostics2 };
    },
    { schemaPath: schemaPath2, schema }
  );
  const lintWarnings = (0, import_chunk_A7W5GDP4.getLintWarningsAsText)(lintDiagnostics);
...
function formatWasm(schema, documentFormattingParams) {
  const formattedSchema = import_chunk_XLW73IUY.prismaSchemaWasm.format(schema, JSON.stringify(documentFormattingParams));
...
async function getGenerators(options) {
  ...
  const config = await (0, import_chunk_AP4ODVUR.getConfig)({
    datamodel,
  ...
  const dmmf = await (0, import_chunk_JLOOQB4K.getDMMF)({
    datamodel,
    datamodelPath: schemaPath,
    prismaPath,
    previewFeatures
...
`
    ...
    const binaryPathsByVersion = await (0, import_chunk_XQZK65HC.getBinaryPathsByVersion)({
      neededVersions,
      binaryTarget,
      version,
      printDownloadProgress,
    ...
    for (const generator of generators) {
      if (generator.manifest && generator.manifest.requiresEngines) {
        ...
        if (engineVersion !== version && generator.options && generator.manifest.requiresEngines.includes(queryEngineType) && generatorBinaryPaths[queryEngineType] && generatorBinaryPaths[queryEngineType]?.[binaryTarget]) {
          const customDmmf = await (0, import_chunk_JLOOQB4K.getDMMF)({
            datamodel,
            datamodelPath: schemaPath,
...
async function checkUnsupportedDataProxyMessage(command, args, implicitSchema) {
  ...
  for (const [argName, argValue] of argList) {
    ...
    if (argName.includes("schema")) {
      ...
      const config2 = await (0, import_chunk_AP4ODVUR.getConfig)({ datamodel: datamodel2, ignoreEnvVarErrors: true });
      const url = (0, import_chunk_AP4ODVUR.resolveUrl)((0, import_chunk_AP4ODVUR.getEffectiveUrl)(config2.datasources[0]));
