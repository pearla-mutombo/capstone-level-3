...
var chunk_AP4ODVUR_exports = {};
__export(chunk_AP4ODVUR_exports, {
...
module.exports = __toCommonJS(chunk_AP4ODVUR_exports);
var import_chunk_ZWZY7GYQ = require("./chunk-ZWZY7GYQ.js");
var import_chunk_VBQDMO2T = require("./chunk-VBQDMO2T.js");
...
[Context: getConfig]`;
    super((0, import_chunk_VBQDMO2T.addVersionDetailsToErrorMessage)(errorMessageWithContext));
  ...
  const configEither = (0, import_function.pipe)(
    (0, import_chunk_ABB2542Q.tryCatch)(
      () => {
        ...
        const data = import_chunk_XLW73IUY.prismaSchemaWasm.get_config(params);
        return data;
      },
      (e) => ({
        type: "wasm-error",
