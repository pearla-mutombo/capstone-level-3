...
var chunk_BEYWX6OE_exports = {};
__export(chunk_BEYWX6OE_exports, {
  exists: () => exists,
  loadEnv: () => loadEnv,
  pathsEqual: () => pathsEqual,
  tryLoadEnvs: () => tryLoadEnvs
});
module.exports = __toCommonJS(chunk_BEYWX6OE_exports);
...
var import_dotenv = (0, import_chunk_OQQ4P4PG.__toESM)(require_main());
