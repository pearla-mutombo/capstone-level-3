...
var chunk_MFF5QDB3_exports = {};
__export(chunk_MFF5QDB3_exports, {
  detect: () => detect,
  getCommand: () => getCommand
});
module.exports = __toCommonJS(chunk_MFF5QDB3_exports);
...
var Node = class {
  constructor(value) {
    (0, import_chunk_OQQ4P4PG.__publicField)(this, "value");
    (0, import_chunk_OQQ4P4PG.__publicField)(this, "next");
    this.value = value;
  }
};
...
var Queue = class {
  constructor() {
    (0, import_chunk_OQQ4P4PG.__privateAdd)(this, _head, void 0);
    (0, import_chunk_OQQ4P4PG.__privateAdd)(this, _tail, void 0);
    (0, import_chunk_OQQ4P4PG.__privateAdd)(this, _size, void 0);
    this.clear();
  }
  enqueue(value) {
    const node = new Node(value);
    if ((0, import_chunk_OQQ4P4PG.__privateGet)(this, _head)) {
      (0, import_chunk_OQQ4P4PG.__privateGet)(this, _tail).next = node;
      (0, import_chunk_OQQ4P4PG.__privateSet)(this, _tail, node);
    } else {
      (0, import_chunk_OQQ4P4PG.__privateSet)(this, _head, node);
      (0, import_chunk_OQQ4P4PG.__privateSet)(this, _tail, node);
    }
    (0, import_chunk_OQQ4P4PG.__privateWrapper)(this, _size)._++;
  }
  dequeue() {
    const current = (0, import_chunk_OQQ4P4PG.__privateGet)(this, _head);
    if (!current) {
      return;
    }
    (0, import_chunk_OQQ4P4PG.__privateSet)(this, _head, (0, import_chunk_OQQ4P4PG.__privateGet)(this, _head).next);
    (0, import_chunk_OQQ4P4PG.__privateWrapper)(this, _size)._--;
    return current.value;
  }
  clear() {
    (0, import_chunk_OQQ4P4PG.__privateSet)(this, _head, void 0);
    (0, import_chunk_OQQ4P4PG.__privateSet)(this, _tail, void 0);
    (0, import_chunk_OQQ4P4PG.__privateSet)(this, _size, 0);
  }
  get size() {
    return (0, import_chunk_OQQ4P4PG.__privateGet)(this, _size);
  }
  *[Symbol.iterator]() {
    let current = (0, import_chunk_OQQ4P4PG.__privateGet)(this, _head);
    while (current) {
      yield current.value;
...
function npmRunPathEnv({ env: env2 = import_process.default.env, ...options } = {}) {
  env2 = { ...env2 };
...
var { constants: BufferConstants } = import_buffer2.default;
...
var verboseDefault = (0, import_util2.debuglog)("execa").enabled;
...
var handleArguments = (file, args, options = {}) => {
  ...
  options = {
    ...
    extendEnv: true,
    preferLocal: false,
    localDir: options.cwd || import_process.default.cwd(),
    execPath: import_process.default.execPath,
    encoding: "utf8",
    reject: true,
    cleanup: true,
