...
var chunk_URNJAKMY_exports = {};
__export(chunk_URNJAKMY_exports, {
  handleLibraryLoadingErrors: () => handleLibraryLoadingErrors
});
module.exports = __toCommonJS(chunk_URNJAKMY_exports);
...
function handleLibraryLoadingErrors(args) {
  ...
  const potentialReasonMessage = (0, import_chunk_4CWLFPLE.N)({ message: error.message, code: error.code }).with({ code: "ENOENT" }, () => `File does not exist.`).when(
