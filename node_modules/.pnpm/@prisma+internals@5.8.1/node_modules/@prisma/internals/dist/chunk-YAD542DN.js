...
var chunk_YAD542DN_exports = {};
__export(chunk_YAD542DN_exports, {
  Prism: () => Prism,
  Token: () => Token
});
module.exports = __toCommonJS(chunk_YAD542DN_exports);
...
function getColorForSyntaxKind(syntaxKind) {
  return import_chunk_63KFPQEY.theme[syntaxKind] || identity;
}
