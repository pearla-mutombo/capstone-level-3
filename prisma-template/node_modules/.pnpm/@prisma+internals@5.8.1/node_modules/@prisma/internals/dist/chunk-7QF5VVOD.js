...
var chunk_7QF5VVOD_exports = {};
__export(chunk_7QF5VVOD_exports, {
  getGeneratorSuccessMessage: () => getGeneratorSuccessMessage
});
module.exports = __toCommonJS(chunk_7QF5VVOD_exports);
...
function formatVersion(generator) {
  ...
  if (generator.getProvider() === "prisma-client-js") {
    const engineType = (0, import_chunk_GLMB7J25.getClientEngineType)(generator.config);
    let engineHint = "";
