...
var chunk_AZ66WJ3B_exports = {};
__export(chunk_AZ66WJ3B_exports, {
  findPrismaClientDir: () => findPrismaClientDir
});
module.exports = __toCommonJS(chunk_AZ66WJ3B_exports);
...
async function findPrismaClientDir(baseDir) {
  ...
  const CLIDir = await (0, import_chunk_TCKAZCW5.resolvePkg)("prisma", resolveOpts);
  const clientDir = await (0, import_chunk_TCKAZCW5.resolvePkg)("@prisma/client", resolveOpts);
