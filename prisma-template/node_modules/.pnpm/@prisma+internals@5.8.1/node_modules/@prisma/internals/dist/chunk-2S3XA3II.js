...
var chunk_2S3XA3II_exports = {};
__export(chunk_2S3XA3II_exports, {
  Generator: () => Generator
});
module.exports = __toCommonJS(chunk_2S3XA3II_exports);
...
var Generator = class {
   ...
   */
  getProvider() {
    return (0, import_chunk_UJCWYERA.parseEnvValue)(this.config.provider);
  }
};
