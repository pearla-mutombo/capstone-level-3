...
var chunk_F23YB57T_exports = {};
__export(chunk_F23YB57T_exports, {
...
module.exports = __toCommonJS(chunk_F23YB57T_exports);
...
[Context: getConfig]`;
    super((0, import_chunk_TMUCIOFX.addVersionDetailsToErrorMessage)(errorMessageWithContext));
    ...
    (0, import_chunk_ABB2542Q.tryCatch)(
      () => {
        if (process.env.FORCE_PANIC_QUERY_ENGINE_GET_CONFIG) {
          ...
          import_chunk_OT6ZRDDF.prismaSchemaWasm.debug_panic();
        }
        ...
        const data = import_chunk_OT6ZRDDF.prismaSchemaWasm.get_config(params);
        return data;
      },
      (e) => ({
        type: "wasm-error",
