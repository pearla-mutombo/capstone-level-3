...
var chunk_JLOOQB4K_exports = {};
__export(chunk_JLOOQB4K_exports, {
  GetDmmfError: () => GetDmmfError,
  getDMMF: () => getDMMF
});
module.exports = __toCommonJS(chunk_JLOOQB4K_exports);
      ...
      return (0, import_function.pipe)(
        (0, import_chunk_ABB2542Q.tryCatch)(
          () => {
            ...
            const data = import_chunk_XLW73IUY.prismaSchemaWasm.get_dmmf(params);
            return data;
          },
          (e) => ({
            type: "wasm-error",
