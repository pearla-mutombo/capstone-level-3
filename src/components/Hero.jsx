...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-[var(--ink)] py-28 text-center text-white">
      <div className="pointer-events-none absolute -right-24 -top-24 opacity-20">
        <Spark className="h-96 w-96 animate-pulse" />
      </div>

      <p className="font-mono-label relative mb-4 flex items-center justify-center gap-2 text-sm uppercase text-[var(--spark)]">
      ...
      <h2 className="relative mx-auto max-w-3xl text-5xl font-bold tracking-tight sm:text-6xl">
        Welcome to <span className="text-[var(--spark)]">NOVUS</span> Market
      </h2>
      ...
      <div className="relative mt-10 space-x-4">
        <NavLink
          to="/products"
          className="inline-block rounded-lg bg-[var(--spark)] px-7 py-3.5 font-semibold text-[var(--ink)] transition hover:brightness-95">
          Shop Now
        </NavLink>
